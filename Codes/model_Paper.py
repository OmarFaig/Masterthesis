...
from utils.seedformer_utils import vTransformer, PointNet_SA_Module_KNN, MLP_Res, MLP_CONV, fps_subsample, query_knn, \
...
class SeedFormer(nn.Module):
    ...
    def forward_decoder(self, feat, partial_cloud, patch_xyz, patch_feat):
        ...
        # Upsample layers
        pcd = torch.cat([seed, partial_cloud], 1)  # (B, num_p0, 3)
        K_prev = None
