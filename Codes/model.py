...
class FeatureExtractor(nn.Module):
    def __init__(self, out_dim=1024, n_knn=20):
        ...
        self.sa_module_1 = PointNet_SA_Layer(npoints=1000,nsample=16,in_channel=6,mlp_channels=[64,128] )
        self.transformer_1 = vTransformer(128, dim=64, n_knn=n_knn)
        self.sa_module_2 = PointNet_SA_Layer(npoints=500,nsample=8,in_channel=131,mlp_channels=[128,256])
